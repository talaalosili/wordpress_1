...
if ( ! class_exists( 'Prime_Portfolio_Resume_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Prime_Portfolio_Resume_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$prime_portfolio_resume_contents = wp_remote_retrieve_body( $response );

			return $prime_portfolio_resume_contents;
		}
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Prime_Portfolio_Resume_WPTT_WebFont_Loader( $url );
