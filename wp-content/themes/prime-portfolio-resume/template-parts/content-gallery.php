...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
	 ...
	 <?php
		    ...
		    $prime_portfolio_resume_post_id = get_the_ID(); // Add this line to get the post ID
		    $prime_portfolio_resume_single_content_setting = get_post_gallery();
		    if (!empty($prime_portfolio_resume_single_content_setting)) {
		        // Display the gallery
		        echo '<div class="embedded-gallery">' . do_shortcode($prime_portfolio_resume_single_content_setting) . '</div>';
		    }
		?>
    <?php
